    ...
    return (
        <div>
            ...
            <form>
                ...
                <input className='auth__input' type='text' placeholder='Name' autoComplete='off' name='name' />
                <input className='auth__input' type='text' placeholder='Email' autoComplete='off' name='email' />
